...
**Project Overview:**
This project focuses on analyzing the performance of YouTube videos posted by Netflix India. The dataset includes key video metadata such as view counts, likes, comments, duration, and publishing details. The primary goal is to uncover trends and generate actionable insights to help Netflix India optimize its YouTube content strategy for better audience engagement.
...
**Focus on Shorter Videos**: Create content with a duration of 5 minutes or less to maximize viewer engagement.

**Use Specific Tags**: Ensure videos are tagged with trending and relevant keywords, such as "Netflix Original" and popular show titles.
